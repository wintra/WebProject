            ...
            <div class="col-md-12">
			  ...
			  <option value="design">디자인</option>
				  ...
				  <option value="lesson">레슨/실무</option>
							...
							<select name="categoryDetail" size="1">
			  <option value="design">디자인</option>
				  <option value="IT">IT/프로그래밍</option>
				  <option value="contents">콘텐츠 제작</option>
				  <option value="translation">번역/통역</option>
				  ...
				  <option value="lesson">레슨/실무</option>
                            ...
                            <div class="col-md-12 mt-3">
                              ...
                              <div class=" border tab-content mt-2">
                                <div class="tab-pane fade active show" id="tabone" role="tabpanel">
                                  <textarea cols="100" name="tabone" rows="40" style="width:100%; border:#64CEC5; resize:none;"></textarea>
                                </div>
                        ...
                        <div class="col-md-4" style="">
                          ...
                          </div><a class="btn btn-primary btn-block" href="writeContentAction" style="">작성완료</a>
                        </div>
                      </div>
                    </div>
                  </div>
