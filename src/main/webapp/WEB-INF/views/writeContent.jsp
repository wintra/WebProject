...
<body>
	...
	<script type="text/javascript">
		...
		function chnQnaType(type, select) {
			...
			if (type == '1') { // 일반관련
				$('#categoryDetail').append("<option value='100' >포토샵</option>");
				$('#categoryDetail').append("<option value='101' >일러스트레이터</option>");
				$('#categoryDetail').append("<option value='102' >제품디자인</option>");
				$('#categoryDetail').append("<option value='103' >건축</option>");
				$('#categoryDetail').append("<option value='104' >UX/UI디자인</option>");
				$('#categoryDetail').append("<option value='105' >편집디자인</option>");
				$('#categoryDetail').append("<option value='106' >캘리그라피</option>");
				$('#categoryDetail').append("<option value='107' >기타</option>");
			} else if (type == '2') { // 일반관련
				$('#categoryDetail').append("<option value='200' >웹개발</option>");
				$('#categoryDetail').append("<option value='201' >앱개발</option>");
				$('#categoryDetail').append("<option value='202' >보안</option>");
				$('#categoryDetail').append("<option value='203' >데이터베이스</option>");
				$('#categoryDetail').append("<option value='204' >알고리즘</option>");
				$('#categoryDetail').append("<option value='205' >게임</option>");
				$('#categoryDetail').append("<option value='206' >기타</option>");
			} else if (type == '3') { // 주문관련
				$('#categoryDetail').append("<option value='300' >영상촬영-편집</option>");
				$('#categoryDetail').append("<option value='301' >사진촬영</option>");
				$('#categoryDetail').append("<option value='302' >애니메이션</option>");
				$('#categoryDetail').append("<option value='303' >유튜브제작</option>");
													...
													<div class="col-md-8" style="">
														...
														<div class="row">
															<div class="col-md-12 mt-3">
																<labelfor"file">썸네일로 사용할 사진을 올려주세요
