    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 order-md-1">
          <form class="needs-validation" action="talentRegisterAction">
            <div class="row">
            ...
            <div class="row">
              <div class="col-md-6 mb-3"> <label for="accountNum">계좌번호<br></label> <input type="text" class="form-control w-100" name="accountNum" placeholder="계좌번호를 입력해주세요.">
                <div class="invalid-feedback" style=""> Please select a valid country. </div>
              </div>
