						...
						<ul class="nav mt-2" style="">
							<li class="nav-item dropdown text-capitalize" style=""><a
								...
								<div class="dropdown-menu" x-placement="bottom-start"
									...
									<a class="dropdown-item" href="mainContent.do?content=123">포토샵<br></a><a
					...
					<div class="row">
						<div class="col-md-12 mt-4">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="blockquote">
										<p class="mb-0 border-bottom rounded-bottom">이런건 어떻세요?</p>
									</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-4 col-md-1 align-self-center">
					<a href="#"> <i class="fa fa-fw fa-facebook text-muted fa-2x"></i>
					</a>
				</div>
				<div class="col-4 col-md-1 align-self-center">
					<a href="#"> <i class="fa fa-fw fa-twitter text-muted fa-2x"></i>
					</a>
				</div>
				<div class="col-4 col-md-1 align-self-center">
					<a href="#"> <i class="fa fa-fw fa-instagram text-muted fa-2x"></i>
					</a>
				</div>
			</div>
			<div class="row">
